 ...
 * 
 */
public class AStringActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a_string);
		// 初始化控件
		initView();
	...
	public void read(View v) {
		...
		if (testString == null) {
			Toast.makeText(this, "没有缓存数据", Toast.LENGTH_SHORT)
					.show();
